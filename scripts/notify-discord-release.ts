  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Launchpad prerelease is available for nightly testers."
          : "A new Launchpad latest release is available.",
...
).pipe(Command.withDescription("Post a Launchpad release announcement to Discord."));
