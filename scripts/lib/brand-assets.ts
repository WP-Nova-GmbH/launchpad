export const BRAND_ASSET_PATHS = {
  ...
  productionIosIconPng: "assets/prod/launchpad-ios-1024.png",
  productionMacIconPng: "assets/prod/launchpad-macos-1024.png",
  productionLinuxIconPng: "assets/prod/launchpad-universal-1024.png",
  productionWindowsIconIco: "assets/prod/launchpad-windows.ico",
  productionWebFaviconIco: "assets/prod/launchpad-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/launchpad-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/launchpad-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/launchpad-web-apple-touch-180.png",
