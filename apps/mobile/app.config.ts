    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Launchpad agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Launchpad to connect to Launchpad servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Launchpad to access your camera so you can scan pairing QR codes.",
