...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Launchpad Connect" section title + refresh button for hosts that
...
/**
 * "Launchpad Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Launchpad Connect
 * onboarding sheet.
 *
      ...
      !controller.relayDiscovery.isRefreshing ? (
        <View collapsable={false} className="gap-3 rounded-[24px] bg-card p-5">
          <Text className="text-base font-t3-bold text-foreground">
            Could not load Launchpad Connect environments
          </Text>
