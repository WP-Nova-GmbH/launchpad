            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Launchpad could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Launchpad still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
