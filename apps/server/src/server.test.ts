    ...
    const appLayer = servedRoutesLayer.pipe(
      ...
      Layer.provide(
        Layer.mock(CloudCliTokenManager.CloudCliTokenManager)({
          get: Effect.die(new Error("Unexpected Launchpad Connect CLI authorization request.")),
...
it.layer(NodeServices.layer)("server router seam", (it) => {
  ...
  it.effect("serves the documented Launchpad Connect mint credential endpoint", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
  ...
  it.effect("serves signed Launchpad Connect environment health checks", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
