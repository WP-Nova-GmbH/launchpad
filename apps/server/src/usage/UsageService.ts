 ...
 *
 * The scan reads the provider CLIs' own session files rather than Launchpad's
 * orchestration projections, so usage covers turns driven outside Launchpad too.
