...
function ChatViewContent(props: ChatViewProps) {
  ...
  // the sent message can stay near the top. Launchpad only owns streaming adjustments
  ...
  const rightPanelContent = activeThreadRef ? (
    activeRightPanelSurface?.kind === "preview" ? (
      ...
      <PullRequestsUnavailableState
        ...
        error="Update this environment's Launchpad server to browse pull requests."
      />
