...
/**
 * Post-sign-in onboarding wizard for Launchpad Connect. Opens on every in-session
 ...
 * account's Launchpad Connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "Launchpad Connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Launchpad Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Launchpad Connect."
