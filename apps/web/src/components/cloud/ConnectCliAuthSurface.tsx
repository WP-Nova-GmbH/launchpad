  ...
  return (
    <AuthSurfaceShell>
      <ConnectCliAuthMessage
        ...
        description={
          isSignedIn
            ? "Redirecting to authorize Launchpad Connect for your CLI…"
            : "Sign in to continue authorizing Launchpad Connect for your CLI."
        }
      />
      {isLoaded && !isSignedIn ? (
        <div className="mt-6">
  ...
  return (
    <AuthSurfaceShell>
      ...
      <p className="mt-6 text-xs leading-relaxed text-muted-foreground">
        ...
        their machine to your Launchpad Connect account while it is valid.
      </p>
    </AuthSurfaceShell>
  );
}
