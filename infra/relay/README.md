# Launchpad Connect Relay

> [!NOTE]
> Sign in to Launchpad Connect from the app under Settings > Connections.

The relay is the hosted control plane for Launchpad Connect. It helps clients discover and connect to
...
The relay is intentionally not in the hot path for normal Launchpad traffic. After a client connects,
regular API and WebSocket traffic goes directly between that client and the selected environment.
See the [Launchpad Connect architecture overview](../../docs/internals/t3-code-connect-auth-flow.html) for the larger system
design.
...
- Linking Launchpad environments to a cloud account.
...
- [Launchpad Connect Clerk Setup](../../docs/internals/t3-connect.md) for Clerk keys, JWT templates, and sign-up restrictions
  setup.
- [Relay Observability](../../docs/operations/relay-observability.md) for deployment tracing and diagnostics.
- [Launchpad Connect Architecture Overview](../../docs/internals/t3-code-connect-auth-flow.html) for the full link,
