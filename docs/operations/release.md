...
- Reads the shared production Launchpad Connect relay URL and Clerk client configuration before packaging clients.
...
## Launchpad Connect relay deployment
...
10. Complete the Clerk Native API and AASA setup in [Launchpad Connect Clerk Setup](../internals/t3-connect.md#desktop-passkeys).
